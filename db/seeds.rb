...
comp_ascorbic_acid        = eustace.components.create!({name: 'Ascorbic Acid',                        total_amount: '100 g',       serving_size: '1000 mg',  price: '5.56 USD',  url: "http://purebulk.com/vitamin-c-ascorbic-acid-powder.html"})
comp_biotin               = eustace.components.create!({name: 'Biotin (1%)',                          total_amount: '1 kg',        serving_size: '77 mg',    price: '9.50 USD',  url: "http://purebulk.com/biotin-1-vitamin-b7-vitamin-h.html", nutritional_label_url: "http://purebulk.com/media/wysiwyg/blanco/default/supp_labels/biotin_1.png"})
comp_c_carbonate          = eustace.components.create!({name: 'Calcium Carbonate',                    total_amount: '500 g',       serving_size: '1250 mg',  price: '17.50 USD', url: "http://purebulk.com/calcium-carbonate-powder-usa.html"})
comp_maltodextrin         = eustace.components.create!({name: 'Maltodextrin',                         total_amount: '50 lb',       serving_size: '1000 g',   price: '60.99 USD', url: "http://store.honeyvillegrain.com/maltodextrin50lb.aspx"})
comp_olive_oil            = eustace.components.create!({name: 'Extra Light Olive Oil',                total_amount: '68 fl oz',    serving_size: '0 g',      price: '13.45 USD', url: "http://www.amazon.com/Bertolli-Extra-Light-Olive-Oil/dp/B008ELNF0Y_1_4?ie=UTF8&qid=1365725469&sr=8-4&keywords=bertolli+extra+light+olive+oil"})
comp_whey                 = eustace.components.create!({name: 'Whey Protein Isolate',                 total_amount: '2 lbs',       serving_size: '28.25 g',  price: '27.84 USD', url: "http://nutrabio.com/Products/whey_protein_isolate.htm#.UXq-LyvwJqI"})
comp_salt                 = eustace.components.create!({name: 'Iodized Salt',                         total_amount: '26 oz',       serving_size: '1.5 g',    price: '1.98 USD',  url: "http://www.amazon.com/Hain-Pure-Foods-Salt-Iodized/dp/B000MDACSK/ref=sr_1_cc_1?s=aps&ie=UTF8&qid=1365725608&sr=1-1-catcorr&keywords=hain+iodized+salt" })
comp_calcium_pantothenate = eustace.components.create!({name: 'Calcium Pantothenate',                 total_amount: '250 g',       serving_size: '550 mg',   price: '13.50 USD', url: 'http://purebulk.com/pantothenic-acid-powder-vitamin-b5-calcium-pantothenate.html'})
comp_cholecalciferol      = eustace.components.create!({name: 'Nature Made Vitamin D3',               total_amount: '560 tablet',  serving_size: '1 tablet', price: '116.06 USD',url: 'http://www.amazon.com/Nature-Made-Vitamin-1000-Tablets/dp/B004UH5ICY/ref=sr_1_6?ie=UTF8&qid=1364955557&sr=8-6&keywords=natures+made+d3'})
comp_gtf                  = eustace.components.create!({name: 'Chromium (GTF) Nicotinate Glycinate',  total_amount: '120 capsule', serving_size: '1 capsule',price: '5.55 USD',  url: 'http://www.nutrabio.com/Products/chromium-gtf.htm'})
comp_p_citrate            = eustace.components.create!({name: 'Potassium Citrate',                    total_amount: '250 g',       serving_size: '275 mg',   price: '10 USD',    url: 'http://purebulk.com/potassium-citrate-powder.html' })
comp_c_gluconate          = eustace.components.create!({name: 'Copper Gluconate Anhydrous 1%',        total_amount: '500 g',       serving_size: '160 mg',   price: '18.00 USD', url: 'http://purebulk.com/copper-gluconate-anhydrous-1.html'})
comp_vit_e                = eustace.components.create!({name: 'Nature Made Vitamin E',                total_amount: '225 softgel', serving_size: '160 mg',   price: '18.00 USD', url: 'http://purebulk.com/copper-gluconate-anhydrous-1.html'})
...
ComponentNutrient.create!({amount: '0.9 g',     component: comp_salt,                 nutrient: nu_sodium})
...
ComponentNutrient.create!({amount: '1.6 mg',    component: comp_c_gluconate,          nutrient: nu_copper})
...
recipe.ingredients.create!({servings: 1,    component: comp_c_gluconate})
