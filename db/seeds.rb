...
Nutrient.create!({name: "Potassium",         fda_rda: 3.5,   unit: :g})
Nutrient.create!({name: "Chloride",          fda_rda: 3.4,   unit: :g})
Nutrient.create!({name: "Fiber",             fda_rda: 5,     unit: :g})
Nutrient.create!({name: "Iron",              fda_rda: 18,    unit: :mg})
Nutrient.create!({name: "Phosphorous",       fda_rda: 1,     unit: :g})
Nutrient.create!({name: "Iodine",            fda_rda: 150,   unit: :ug})
Nutrient.create!({name: "Magnesium",         fda_rda: 500,   unit: :mg})
Nutrient.create!({name: "Zinc",              fda_rda: 15,    unit: :mg})
Nutrient.create!({name: "Selenium",          fda_rda: 70,    unit: :ug})
Nutrient.create!({name: "Copper",            fda_rda: 2,     unit: :mg})
Nutrient.create!({name: "Manganese",         fda_rda: 2,     unit: :mg})
Nutrient.create!({name: "Chromium",          fda_rda: 120,   unit: :ug})
Nutrient.create!({name: "Molybdenum",        fda_rda: 75,    unit: :ug})
Nutrient.create!({name: "Vitamin B6",        fda_rda: 2,     unit: :mg})
Nutrient.create!({name: "Vitamin B12",       fda_rda: 6,     unit: :ug})
Nutrient.create!({name: "Vitamin C",         fda_rda: 60,    unit: :mg})
Nutrient.create!({name: "Vitamin D",         fda_rda: 400,   unit: :iu})
Nutrient.create!({name: "Vitamin E",         fda_rda: 30,    unit: :iu})
Nutrient.create!({name: "Vitamin K",         fda_rda: 80,    unit: :ug})
Nutrient.create!({name: "Thiamin",           fda_rda: 1.5,   unit: :mg})
Nutrient.create!({name: "Riboflavin",        fda_rda: 1.8,   unit: :mg})
Nutrient.create!({name: "Niacin",            fda_rda: 20,    unit: :mg})
Nutrient.create!({name: "Folate",            fda_rda: 400,   unit: :ug})
Nutrient.create!({name: "Panthothenic Acid", fda_rda: 10,     unit: :mg})
