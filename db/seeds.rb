...
comp_ascorbic_acid        = Component.create!({total_amount: '100 g',    serving_size: '1000 mg', price: '5.56 $',  name: 'Ascorbic Acid',               url: "http://purebulk.com/vitamin-c-ascorbic-acid-powder.html"})
comp_biotin               = Component.create!({total_amount: '1 kg',     serving_size: '77 mg',   price: '9.50 $',  name: 'Biotin (1%)',                 url: "http://purebulk.com/biotin-1-vitamin-b7-vitamin-h.html"})
comp_c_carbonate          = Component.create!({total_amount: '500 g',    serving_size: '1250 mg', price: '17.50 $', name: 'Calcium Carbonate',           url: "http://purebulk.com/calcium-carbonate-powder-usa.html"})
comp_maltodextrin         = Component.create!({total_amount: '50 lb',    serving_size: '1000 g',  price: '60.99 $', name: 'Maltodextrin',                url: "http://store.honeyvillegrain.com/maltodextrin50lb.aspx"})
comp_olive_oil            = Component.create!({total_amount: '68 fl oz', serving_size: '0 g',        price: '13.45 $', name: 'Extra Light Olive Oil',       url: "http://www.amazon.com/Bertolli-Extra-Light-Olive-Oil/dp/B008ELNF0Y_1_4?ie=UTF8&qid=1365725469&sr=8-4&keywords=bertolli+extra+light+olive+oil"})
comp_whey                 = Component.create!({total_amount: '2 lbs',    serving_size: '28.25 g', price: '27.84 $', name: 'Whey Protein Isolate (100%)', url: "http://nutrabio.com/Products/whey_protein_isolate.htm#.UXq-LyvwJqI"})
comp_salt                 = Component.create!({total_amount: '26 oz',    serving_size: '1.5 g',   price: '1.98 $',  name: 'Iodized Salt',                url: "http://www.amazon.com/Hain-Pure-Foods-Salt-Iodized/dp/B000MDACSK/ref=sr_1_cc_1?s=aps&ie=UTF8&qid=1365725608&sr=1-1-catcorr&keywords=hain+iodized+salt" })
comp_calcium_pantothenate = Component.create!({total_amount: '250 g',    serving_size: '550 mg',  price: '13.50 $', name: 'Calcium Pantothenate',        url: 'http://purebulk.com/pantothenic-acid-powder-vitamin-b5-calcium-pantothenate.html'})
...
# ComponentNutrient.create!({amount: '',          component: comp_olive_oil,     nutrient: nu_fat})
...
recipe.ingredients.create!({servings: 1.33, component: comp_biotin})
